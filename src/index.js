	...
	( BlockListBlock ) => ( props ) => {
		...
		return (
			...
			>
				...
				<PinOverlay
					label={ __( 'Bloque pineado', 'sectioncore-pin-freeze' ) }
					actionLabel={ __( 'Despinear bloque', 'sectioncore-pin-freeze' ) }
...
function PostFreezeOverlay() {
	...
	return createPortal(
		<PinOverlay
			...
			label={ __( 'Entrada/Página pineada', 'sectioncore-pin-freeze' ) }
			onRequestUnpin={ onRequestUnpin }
		/>,
		target
	);
...
addFilter(
	...
	'sectioncore-pin-freeze/add-attributes',
	addPinAttributes
);
addFilter(
	'editor.BlockEdit',
	'sectioncore-pin-freeze/block-pin-control',
	withBlockPinControl
);
addFilter(
	'editor.BlockListBlock',
	'sectioncore-pin-freeze/block-pin-overlay',
	withPinOverlay
);

registerPlugin( 'sectioncore-pin-freeze-document-plugin', {
